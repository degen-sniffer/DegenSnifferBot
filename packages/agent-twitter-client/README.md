...
This is a modified version of [agent-twitter-client](https://github.com/elizaOS/agent-twitter-client) with added functionality for sending tweets and retweets. This package does not require the Twitter API to use and will run in both the browser and server.
